...
export default function Footer() {
    ...
    return (
        <footer className="px-4 md:px-16 lg:px-24 text-[13px] mt-32 text-foreground">
            <div className="flex flex-wrap items-start min-md:justify-between gap-10 md:gap-15">
                ...
                <div className="max-w-80 md:ml-40">
                    <p className='font-semibold text-foreground'>Sign up for newsletter</p>
            ...
            <div className="flex flex-col md:flex-row py-7 mt-12 border-gray-200 md:justify-between max-md:items-center border-t max-md:text-center gap-2 items-end">
                <p className="text-center">
                    © 1406 <a href="https://prebuiltui.com?utm_source=material" target="_blank">رابط کاربری پیش ساخته</a>
                    {' '} • توزیع شده توسط <a href="https://themewagon.com" target="_blank">شمایل ترابی</a>
                . تمام حقوق محفوظ.</p>
