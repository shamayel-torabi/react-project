...
export default function Teams() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 bg-background-1">
      <SectionTitle title='تیم' subtitle='تیم ما متشکل از افراد ذیل می باشد.' />
        ...
        <div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between gap-4">
              ...
              >
                <span id="LinkedInLabel1" className="sr-only">LinkedIn</span>
        ...
        <div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between gap-4">
              ...
              >
                <span id="LinkedInLabel2" className="sr-only">LinkedIn</span>
        ...
        <div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between gap-4">
              ...
              >
                <span id="LinkedInLabel3" className="sr-only">LinkedIn</span>
