  ...
  return (
    <motion.section initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ ease: "easeOut", duration: 1 }} id="what_we_do" className="min-h-svh flex flex-col items-center justify-center bg-section-background">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-20">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-100 max-w-md">
          ...
          <p className="mt-8">PrebuiltUI helps you build faster by transforming your design vision into fully functional, production-ready UI components. </p>
          <p className="mt-4">
            Whether you're launching a SaaS app, landing page, or dashboard, our collection of Tailwind CSS components is crafted to boost your development
            speed and improve user experience.
          </p>
          <p className="mt-4">From UI design systems to automation-ready layouts, PrebuiltUI empowers you to build beautifully and scale effortlessly.</p>
          <button className="flex items-end gap-2 mt-8 hover:opacity-90 transition btn py-3 px-8 rounded-full text-black dark:text-white ">
