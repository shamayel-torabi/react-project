...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="flex flex-col items-center justify-center relative h-svh overflow-hidden">
      <h1 className="text-2xl md:text-4xl/18 text-center font-semibold max-w-2xl bg-linear-to-r from-[#0601fa] to-[#05e2f1] text-transparent bg-clip-text">
